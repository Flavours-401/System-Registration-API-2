...
urlpatterns = [
    ...
    path("custom_user_list/<int:pk>/",
         CustomUserListDetail.as_view(), name="CustomUserListDetail"),

    path("admin_list/", AdminHODList.as_view(), name="AdminHODList"),
    path("admin_list/<int:pk>/", AdminHODListDetail.as_view(),
         name="AdminHODListDetail"),
    ...
    path("attedance_list/<int:pk>/",
         AttendanceDetail.as_view(), name="AttendanceDetail"),

    path("attedance_report_list/", AttendanceReportList.as_view(),
         name="AttendanceReportList"),
    path("attedance_report_list/<int:pk>/",
         AttendanceReportDetail.as_view(), name="AttendanceReportDetail"),

    path("leave_report_student/", LeaveReportStudentList.as_view(),
         name="LeaveReportStudentList"),
    path("leave_report_student/<int:pk>/",
         LeaveReportStudentDetail.as_view(), name="LeaveReportStudentDetail"),

    path("leave_report_staff/", LeaveReportStaffList.as_view(),
         name="LeaveReportStaffList"),
    path("leave_report_staff/<int:pk>/",
         LeaveReportStaffDetail.as_view(), name="LeaveReportStaffDetail"),

    path("feedback_student/", FeedBackStudentList.as_view(),
         name="FeedBackStudentList"),
    path("feedback_student/<int:pk>/", FeedBackStudentDetail.as_view(),
         name="FeedBackStudentDetail"),

    path("feedback_staff/", FeedBackStaffsList.as_view(),
         name="FeedBackStaffsList"),
    path("feedback_staff/<int:pk>/", FeedBackStaffsDetail.as_view(),
         name="FeedBackStaffsDetail"),

    path("notification_student/", NotificationStudentList.as_view(),
         name="NotificationStudentList"),
    path("notification_student/<int:pk>/",
         NotificationStudentDetail.as_view(), name="NotificationStudentDetail"),

    path("notification_staff/", NotificationStaffsList.as_view(),
         name="NotificationStaffsList"),
    path("notification_staff/<int:pk>/",
         NotificationStaffsDetail.as_view(), name="NotificationStaffsDetail"),

    path("manage_session/", SessionYearList.as_view(), name="SessionYearList"),
    path("manage_session/<int:pk>/",
         SessionYearDetail.as_view(), name="SessionYearDetail"),
